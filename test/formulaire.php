...
<html>
	...
	<head>
			...
			<script type='text/javascript' src='scripts/formulaire_dynamique.js'></script>
	...
	<body onload='fmOptionsHidden()'>
		...
		<form methode='post' action='resume_fm.php'>
			...
			<div id='fm_diabete' >
				...
				<span>
					<label for='hba1c'>Hba1C(la plus récente)</label>:<input type='number' name='hba1c' id='hba1c' /></br>
				</span>
				<span>
					<label for='anciennete'>Ancienneté du diabète</label>:<input type='number' name='anciennete' id='anciennete' />
				</span>
				<span>
				...
				<span>
					<label for='traitementad'>Traitement antidiabétique actuel:</label></br>
					<textarea name='traitementad' id='traitementad'></textarea>
				</span>
				<span>
